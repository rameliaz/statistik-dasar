...
* Apabila asumsi ini dilanggar, maka residual mengalami **heteroskedastisitas**. Koefisien regresi (B) tetap **tidak bias**, namun **_standard error_-nya menjadi bias** — sehingga _p-value_ dan _confidence interval_ tidak dapat diandalkan.
...
* Ambang batas umum: _Cook's D_ **> 1** mengindikasikan observasi yang berpengaruh besar (*influential*); ambang yang lebih sensitif/liberal, > 4/n, sering dipakai untuk *n* besar.
