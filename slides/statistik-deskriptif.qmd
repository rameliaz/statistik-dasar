...
* *"…the first principle is that you must not fool yourself — you're the easiest person to fool."* — Richard Feynman (1974)
* Statistik membantu kita **mendisiplinkan intuisi** agar tidak tertipu oleh kebetulan

::: {.callout-important}
*Statistical thinking* jauh lebih penting daripada *software*-nya. Tidak masalah menggunakan `jamovi`, `JASP`, <i class="fa-brands fa-r-project"></i>, atau `SPSS`, yang terpenting adalah tahu **cara kerja** setiap *tools* dan **alasan** menggunakannya.
:::
...
* Berbasis bahasa pemrograman <i class="fa-brands fa-r-project"></i> — transparan dan *reproducible*
...
* Alternatif lain: `JASP` (UI hampir sama, lebih unggul untuk *latent variable modeling* dan *network analysis*)
...
Buka dataset [**HDIWDI2010**](/docs/materials/HDIWDI2010.omv), kemudian hitung *mean*, median, dan modus angka kehamilan remaja (*teenfert*):
...
Dengan dataset yang sama ([**HDIWDI2010.omv**](/docs/materials/HDIWDI2010.omv)), hitung *range*, IQR, varians, dan standar deviasi *teenfert*:
...
* [*Anscombe's quartet*](https://en.wikipedia.org/wiki/Anscombe%27s_quartet): empat dataset dengan *mean*, SD, dan korelasi yang **identik** — tapi bentuknya sangat berbeda
...
| **_Ogive_** | Kurva frekuensi kumulatif; cocok untuk data kontinu atau interval/rasio |
...
Dengan dataset [**HDIWDI2010.omv**](/docs/materials/HDIWDI2010.omv), inspeksi distribusi *teenfert* secara visual:
...
::: {.callout-note}
Distribusi normal adalah **asumsi dasar** dari hampir semua teknik statistik parametrik (t-test, ANOVA, regresi) — selalu cek dulu apakah data kita mendekati distribusi normal sebelum memilih teknik analisis.
:::
...
* Tapi **tidak semua data psikologi berdistribusi normal**
...
* Versi standar (tanpa koreksi Lilliefors) cenderung memberikan hasil *misleading* — **tidak direkomendasikan** untuk penggunaan umum
* Justru **kurang reliabel pada sampel kecil** (daya uji/power rendah); Shapiro-Wilk adalah pilihan yang lebih baik untuk sampel kecil hingga sedang
* Versi dengan koreksi Lilliefors (tersedia di beberapa *software*) lebih dapat diandalkan, namun Shapiro-Wilk tetap lebih disarankan di kebanyakan konteks
...
Dengan dataset [**HDIWDI2010.omv**](/docs/materials/HDIWDI2010.omv), uji normalitas distribusi *teenfert*:
