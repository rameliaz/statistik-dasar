...
## *Sampling bias* dan keterwakilan
...
[Henrich et al. (2010)](https://www.cambridge.org/core/journals/behavioral-and-brain-sciences/article/abs/weirdest-people-inthe-world/BF84F7517D56AFF7B7EB58411A554C17) menemukan bahwa sekitar **96% sampel** dalam jurnal psikologi bereputasi berasal dari populasi WEIRD, padahal populasi ini hanya mewakili **12%** populasi manusia di bumi. Ini adalah krisis yang serius dalam Psikologi.
:::
...
* **Data yang lebih banyak → estimasi yang lebih akurat**
...
::: {.callout-important}
#### Penting diingat
*Law of large numbers* menjelaskan mengapa **ukuran sampel kecil bermasalah** dalam penelitian. Dengan N=20, *mean* sampel kita bisa sangat jauh dari *mean* populasi hanya karena kebetulan (*sampling error*). Inilah mengapa mengestimasi *statistical power* dan *sample size* itu penting sebelum penelitian dimulai.
:::

## Implikasi *law of large numbers* untuk penelitian

* ***Effect size* yang kecil** membutuhkan sampel yang **besar** untuk bisa terdeteksi secara konsisten
* Penelitian dengan sampel kecil (*underpowered*) lebih rentan:
  - Gagal mendeteksi efek yang sebenarnya ada (*Type II error*)
  - Menghasilkan *effect size* yang *overestimated* (*winner's curse*)
  - Tidak dapat dicoba ulang (*replication*)
...
* Distribusi *sampling* adalah distribusi teoritis dari suatu **parameter statistik** (misalnya, *mean*) yang dihitung dari semua sampel berukuran *n* yang mungkin diambil dari suatu populasi
* Kita tidak pernah benar-benar mengambil ribuan sampel, jadi distribusi *sampling* adalah konstruk **matematis** yang memungkinkan kita membuat inferensi dari satu sampel

**Mengapa ini penting?**

* Semua uji hipotesis (t-test, ANOVA, chi-square) pada dasarnya membandingkan statistik yang kita observasi dengan distribusi *sampling* yang diharapkan **dengan asumsi bahwa hipotesis nol yang benar di populasi**
* *p-value* = probabilitas mendapati parameter statistik seekstrem yang saat ini diobservasi berdasarkan distribusi *sampling* yang asumsinya $H_0$ benar di populasi
...
* Kita **tidak perlu** berasumsi bahwa data individual dalam populasi berdistribusi normal, karena CLT menjamin bahwa distribusi *sampling* dari *mean* akan mendekati normal selama *n* cukup besar
...
* *Standard error* (SE) adalah **standar deviasi dari distribusi *sampling***, yaitu mengukur seberapa bervariasi statistik sampel kita jika sampel diambil berkali-kali
...
* SE memberikan informasi tentang **ketepatan** (seberapa presisi) estimasi kita:
  - SE kecil → estimasi lebih presisi
  - SE besar → estimasi kurang presisi
...
* SE **dua kali lipat lebih besar**, estimasi jauh kurang presisi karena sampelnya lebih kecil
...
* Apakah ini bukti bahwa MBG "berhasil"? **Belum tentu**. Kita belum punya data pembanding (kelompok kontrol, atau rata-rata sebelum MBG). CI hanya memberi tahu kita seberapa presisi estimasi kita, bukan apakah efeknya riil di populasi.
