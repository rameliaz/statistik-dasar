...
Pertanyaan: Apakah nilai Esmeralda **berbeda secara signifikan** dari rata-rata nasional?
...
**Kesimpulan: Kopi tidak meningkatkan konsentrasi secara signifikan**

Meski 540 mahasiswa adalah sampel yang besar, perbedaan rata-rata konsentrasi sebelum-sesudah minum kopi sangat kecil (*d* = 0.055) dan tidak signifikan (*p* = 0.193). Efek kopi mungkin **bervariasi antar individu** atau **tidak ada secara rata-rata**.
:::

::: {.callout-note}
*p* = 0.193 bukan berarti kopi "terbukti tidak berguna" — kita hanya **gagal menemukan bukti** bahwa kopi berguna dalam kondisi eksperimen ini. Mungkin prosedur pengukuran, jenis kopi, atau waktu tunggu setelah minum kopi perlu dipertimbangkan.
:::
