...
$$\text{Proporsi mediasi} = \frac{a \times b}{c} = \frac{-0.26}{-0.42} \approx 0.62$$

Artinya, sekitar **62%** dari efek beban akademik pada *wellbeing* bekerja melalui mekanisme dukungan sosial.
...
Pada contoh di atas, jamovi melaporkan $\kappa^2 \approx 0.18$.

::: {.callout-note}
Preacher & Kelley (2011), yang memperkenalkan $\kappa^2$, mengusulkan ambang 0.01/0.09/0.25 (analog dengan konvensi Cohen) hanya sebagai panduan awal, dan memperingatkan agar tidak diinterpretasikan secara **kaku** sebagai ambang universal karena nilai maksimum $\kappa^2$ bergantung pada desain dan skala pengukuran. $\kappa^2$ juga makin jarang dipakai di literatur terbaru — **proporsi mediasi** atau **standardized indirect effect** lebih disukai sebagai ukuran *effect size* untuk mediasi.
:::
...
Namun, pengujian secara longitudinal hanya bisa mengendalikan *confounding* yang *time-invariant* saja. Apabila variabel *confounding* berubah sepanjang waktu, maka desain *longitudinal* tidak bisa mengendalikan efek *confounding* tersebut.
:::
...
* Disajikan dengan **bahasa yang jujur** — "konsisten dengan mediasi" bukan "membuktikan mediasi"
