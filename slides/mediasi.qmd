...
::: {.callout-note}
Preacher & Kelley (2011), yang memperkenalkan $\kappa^2$, justru menyarankan untuk **tidak** memakai ambang batas universal (mis. 0.01/0.09/0.25) karena nilai maksimum $\kappa^2$ bergantung pada desain dan skala pengukuran. $\kappa^2$ juga makin jarang dipakai di literatur terbaru — **proporsi mediasi** atau **standardized indirect effect** lebih disukai sebagai ukuran *effect size* untuk mediasi.
:::
