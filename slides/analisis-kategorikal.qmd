...
|---|---|---|---|
| **Cramér's V** | Chi-square (tabel k×m apapun) | 0–1 | 0.10 kecil, 0.30 sedang, 0.50 besar *(berlaku langsung untuk tabel 2×2; untuk tabel lebih besar, ambang batas ini adalah panduan kasar — nilainya bergantung pada df = min(baris−1, kolom−1))* |
