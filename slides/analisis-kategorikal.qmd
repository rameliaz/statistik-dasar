...
**Contoh:** Dalam 200 klien yang menjalani terapi CBT, 130 menunjukkan perbaikan signifikan. Apakah tingkat keberhasilan CBT berbeda dari 60% yang dilaporkan literatur internasional?

$$H_0: p = 0.60 \quad \text{vs} \quad H_1: p \neq 0.60$$

Proporsi sampel = 130/200 = **65%**
...
Buka dataset **terapi.omv** yang berisi data 200 klien CBT:
...
* Berapa besar perbedaan antara proporsi sampel (65%) dan nilai referensi (60%) — apakah perbedaan ini bermakna secara praktis?
...
Frekuensi yang diharapkan (contoh, sel kiri atas): $E = \frac{60 \times 130}{175} = 44.6$
