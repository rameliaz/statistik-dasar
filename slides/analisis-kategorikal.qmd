...
Buka dataset [**terapi.omv**](/materials/terapi.omv) yang berisi data 500 klien CBT:
...
* Khusus tabel **2×2** (bukan tabel yang lebih besar): gunakan *Yates' continuity correction*
...
Buka dataset [**metodebelajar.omv**](/materials/metodebelajar.omv), kemudian uji hubungan antara metode belajar dan kelulusan:
...
Buka dataset [**attitudinal_change.omv**](/materials/attitudinal_change.omv) yang berisi data mahasiswa sebelum dan sesudah kuliah Psikologi Perkembangan:

1. Jalankan *McNemar's test* untuk variabel **sikap_hukuman_fisik** (sebelum vs sesudah)
2. Hitung χ² untuk asosiasi **jurusan** × **perubahan_sikap**
