...
*Analysis of Variance* (ANOVA), dikembangkan oleh Ronald Fisher pada awal abad ke-20, membandingkan *mean* dari **dua atau lebih** kelompok secara bersamaan.
...
Dataset: [**cobaobat.omv**](/docs/materials/cobaobat.omv)
...
Buka dataset [**cobaobat.omv**](/docs/materials/cobaobat.omv), kemudian jalankan *one-way* ANOVA:
...
::: {.callout-tip}
**Gunakan ω² sebagai default**, karena ω² memberikan estimasi yang lebih akurat tentang *effect size* populasi. Sebagian besar *software* statistik secara *default* melaporkan η² karena lebih mudah dihitung, tapi η² cenderung meng*overestimate* ukuran efek, terutama pada sampel yang kecil.
:::
...
|---|---|---|---|
| Plasebo vs Mixagrip | −0.267 | 0.176 | 0.449 |
| Plasebo vs Flungalih | **−1.030** | 0.176 | **< .001** |
| Mixagrip vs Flungalih | **−0.763** | 0.176 | **.002** |

: {tbl-colwidths="[40,22,13,25]"}

Interpretasi:

* Plasebo dan *mixagrip* **tidak berbeda signifikan** (*p* = 0.449)
...
# Merencanakan jumlah sampel {background-color="#14497F"}
