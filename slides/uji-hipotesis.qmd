...
::: {.callout-important}
Dari ~42-43 hasil "signifikan", **2-3 di antaranya adalah kesalahan** (*false positive*). Semakin rendah *base rate* kebenaran klaim (misalnya bidang pre-clinical), semakin besar proporsi *false positive* di antara hasil signifikan — inilah salah satu akar *replication crisis*.
:::
